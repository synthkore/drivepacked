        ...
        *******************************************************************************/
        static public int convertAndReverseUInt32To4Bytes(UInt32 ui32_value, byte[] by_converted ){
            ...
            if (by_converted.Length != 4){
                ...
                // byte 0
                by_converted[0] = (byte)((ui32_value & 0x0000000F)<<4);
                by_converted[0] = (byte)( by_converted[0] | ((ui32_value&0x000000F0)>>4) );
                // byte 1
                by_converted[1] = (byte)((ui32_value & 0x00000F00)>>4);
                by_converted[1] = (byte)(by_converted[1] | ((ui32_value & 0x0000F000)>>12));
                // byte 2
                by_converted[2] = (byte)((ui32_value & 0x000F0000) >> 12);
                by_converted[2] = (byte)(by_converted[2] | ((ui32_value & 0x00F00000)>> 20));
                // byte 3
                by_converted[3] = (byte)((ui32_value & 0x0F000000) >>20);
                by_converted[3] = (byte)(by_converted[3] | ((ui32_value & 0xF0000000)>> 28));
            }//if
